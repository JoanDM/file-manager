...
def list_all_image_filepaths_in_dir(directory):
    return list_all_filepaths_in_dir_with_specific_extension(directory,
                                                             ["png", "jpg", "jpeg",
                                                              "bmp", "heic"])
